    ...
    private class sendLocation extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                HttpPost httpPost = new HttpPost("http://"+serverIP+"/geobus/post.php");
	            /*El objeto HttpPost permite que enviemos una peticion de tipo POST a una URL especificada*/
                //HttpPost httppost = new HttpPost(posturl);

                //AÑADIR PARAMETROS
                List<NameValuePair> params1 = new ArrayList<NameValuePair>();
                params1.add(new BasicNameValuePair("latitud",lat+""));
                params1.add(new BasicNameValuePair("longitud",lng+""));
                params1.add(new BasicNameValuePair("id",deviceID));
                params1.add(new BasicNameValuePair("activo",1+""));
                ...
                x = resp.getStatusLine().getStatusCode();
